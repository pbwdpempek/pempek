...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/ciboos/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Theme CSS -->
    <link href="/ciboos/bootstrap/css/agency.min.css" rel="stylesheet">
...
<body id="page-top" class="index">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <img src="img/pempek-lenjer.png" width="130" height="100"/>
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                       <img src="img/pempek-kapalselam.jpg" width="130" height="100"/>
                ...
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <img src="img/pempek-adaan.jpg" width="100" height="100"/>
                    </span>
    ...
    <!-- jQuery -->
    <script src="/ciboos/bootstrap/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="/ciboos/bootstrap/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js" integrity="sha384-mE6eXfrb8jxl0rzJDBRanYqgBxtJ6Unn4/1F7q4xRRyIw7Vdg9jP4ycT7x1iVsgb" crossorigin="anonymous"></script>

    <!-- Contact Form JavaScript -->
    <script src="/ciboos/bootstrap/js/jqBootstrapValidation.js"></script>
    <script src="/ciboos/bootstrap/js/contact_me.js"></script>

    <!-- Theme JavaScript -->
    <script src="/ciboos/bootstrap/js/agency.min.js"></script>
